...
type (
	...
	OrderModel interface {
		...
		FindOneByQuery(ctx context.Context, rowBuilder squirrel.SelectBuilder) (*Order, error)
...
func (m *defaultOrderModel) DeleteSoft(ctx context.Context, session sqlx.Session, data *Order) error {
	...
	if err := m.UpdateWithVersion(ctx, session, data); err != nil {
		return errors.Wrapf(xerr.NewErrMsg("删除数据失败"), "OrderModel delete err : %+v", err)
	}
	return nil
}

func (m *defaultOrderModel) FindOneByQuery(ctx context.Context, rowBuilder squirrel.SelectBuilder) (*Order, error) {
...
func (m *defaultOrderModel) FindSum(ctx context.Context, sumBuilder squirrel.SelectBuilder) (float64, error) {
...
func (m *defaultOrderModel) FindPageListByPage(ctx context.Context, rowBuilder squirrel.SelectBuilder, page, pageSize int64, orderBy string) ([]*Order, error) {
...
func (m *defaultOrderModel) FindPageListByIdDESC(ctx context.Context, rowBuilder squirrel.SelectBuilder, preMinId, pageSize int64) ([]*Order, error) {
...
// 按照id升序分页查询数据，不支持排序
func (m *defaultOrderModel) FindPageListByIdASC(ctx context.Context, rowBuilder squirrel.SelectBuilder, preMaxId, pageSize int64) ([]*Order, error) {

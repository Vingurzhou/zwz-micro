...
// source: zwzchain/extension/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_1f360e070eb5d86c, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_1f360e070eb5d86c, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "zwzchain.extension.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "zwzchain.extension.QueryParamsResponse")
}

func init() { proto.RegisterFile("zwzchain/extension/query.proto", fileDescriptor_1f360e070eb5d86c) }

var fileDescriptor_1f360e070eb5d86c = []byte{
	// 288 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xab, 0x2a, 0xaf, 0x4a,
	0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x4f, 0xad, 0x28, 0x49, 0xcd, 0x2b, 0xce, 0xcc, 0xcf, 0xd3, 0x2f,
	...
	0xb0, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x96, 0xbd, 0xb9, 0x82, 0xe3, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/zwzchain.extension.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zwzchain.extension.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "zwzchain.extension.Query",
	...
	Metadata: "zwzchain/extension/query.proto",
}
